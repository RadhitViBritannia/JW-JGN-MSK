...
<div class="card-body py-5">
        ...
        <input type="text" name="nama_lengkap" class="form-control mb-4" placeholder="Nama Lengkap"><div class="form-inline btn-a">
        <a href="register.php" class="btn btn-primary">Saya Pengguna Baru</a>
